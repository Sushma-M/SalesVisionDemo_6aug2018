...
public class SalesdbQueryExecutorServiceImpl implements SalesdbQueryExecutorService {
    ...
    @Transactional(value = "salesdbTransactionManager", readOnly = true)
    @Override
    public Page<SalesByRepResponse> executeSalesByRep(String repid, Pageable pageable) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("repid", repid);

        return queryExecutor.executeNamedQuery("SalesByRep", params, SalesByRepResponse.class, pageable);
    }

    @Transactional(value = "salesdbTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportSalesByRep(String repid, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("repid", repid);

        QueryProcedureInput<SalesByRepResponse> queryInput = new QueryProcedureInput<>("SalesByRep", params, SalesByRepResponse.class);
