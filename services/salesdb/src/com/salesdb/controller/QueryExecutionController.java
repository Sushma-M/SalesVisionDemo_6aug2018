...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/SalesByRep", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Sales done by rep")
    public Page<SalesByRepResponse> executeSalesByRep(@RequestParam(value = "repid") String repid, Pageable pageable, HttpServletRequest _request) {
        LOGGER.debug("Executing named query: SalesByRep");
        Page<SalesByRepResponse> _result = queryService.executeSalesByRep(repid, pageable);
        LOGGER.debug("got the result for named query: SalesByRep, result:{}", _result);
        return _result;
    }

    @ApiOperation(value = "Returns downloadable file for query SalesByRep")
    @RequestMapping(value = "/queries/SalesByRep/export/{exportType}", method = RequestMethod.GET, produces = "application/octet-stream")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Downloadable exportSalesByRep(@PathVariable("exportType") ExportType exportType, @RequestParam(value = "repid") String repid, Pageable pageable, HttpServletRequest _request) {
        LOGGER.debug("Exporting named query: SalesByRep");

        return queryService.exportSalesByRep(exportType, repid, pageable);
    }
