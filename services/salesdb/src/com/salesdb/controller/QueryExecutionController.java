...
public class QueryExecutionController {
    ...
    @ApiOperation(value = "Returns downloadable file url for query SalesByRep")
    @RequestMapping(value = "/queries/SalesByRep/export", method = RequestMethod.POST)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportSalesByRep(@RequestParam(value = "repid") String repid, @RequestBody ExportOptions exportOptions, Pageable pageable) {
        LOGGER.debug("Exporting named query: SalesByRep");

        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = "SalesByRep";
        }
        exportedFileName += exportOptions.getExportType().getExtension();

        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName,
                        outputStream -> queryService.exportSalesByRep(repid,  exportOptions, pageable, outputStream));
